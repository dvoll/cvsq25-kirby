...
if ($image = $block->image()->toFile()) {
    ...
    $dimensions = $image->dimensions()->fitWidthAndHeight(600, 600);
...
<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
    <tr>
        <td style="background-color: #ffffff; padding-top: 10px;  padding-bottom: 10px;" class="darkmode-bg">
        ...
        <tr>
            <td>
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                        <td
                            style="text-align: center; font-family: sans-serif; line-height: 20px; color: #555555; padding: 0 10px 10px 20px;">
